...
function custom_post_type() {
    ...
    $labels = array(
        ...
        'menu_name' => __('Experience', 'portfolio'),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description' => __('Portfolio experience', 'portfolio'),
        'labels' => $labels,
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description' => __('Portfolio education', 'portfolio'),
        'labels' => $labels,
        'supports' => array('title', 'editor', 'thumbnail', 'revisions'), //'custom-fields',
        'taxonomies' => array(),
        'hierarchical' => false,
...
// Set other options for Custom Post Type
    ...
    $labels = array(
        ...
        'parent_item_colon' => __('Parent Interests', 'portfolio'),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description' => __('Interests education', 'portfolio'),
        'labels' => $labels,
        'supports' => array('title', 'editor', 'thumbnail', 'revisions'), //'custom-fields',
        'taxonomies' => array(),
        'hierarchical' => false,
